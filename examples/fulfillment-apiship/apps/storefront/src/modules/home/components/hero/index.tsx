...
// Read from the storefront's own dependency so the number in the hero cannot
// drift from the SDK we ship. The daily Update Medusa workflow bumps the pin,
// and the next build picks it up. Not translatable, so it lives here rather
// than in 36 message files.
const medusaVersion = dependencies["@medusajs/js-sdk"]
