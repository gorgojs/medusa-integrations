...
![Структура проекта Medusa Storefront после обновления файлов cookie](/static/robokassa/storefront/src-lib-data-cookies.webp)
...
![Структура проекта Medusa Storefront после обновления файла для компонента оплаты](/static/robokassa/storefront/src-modules-checkout-components-payment-index.webp)
...
![Структура проекта Medusa Storefront после создания файла для API route](/static/robokassa/storefront/src-app-api-capture-payment-cartid-route.webp)
