...
Каждый шаг выше написан для стартового шаблона [Medusa Next.js Starter Template](https://github.com/medusajs/nextjs-starter-medusa) и ссылается на витрину, из которой он взят, зафиксированную в [`examples/payment-robokassa/medusa-storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-robokassa/medusa-storefront).

[Пример в `main`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-robokassa) собран на [Medusa DTC Starter](https://github.com/gorgojs/medusa-dtc-starter), в котором уже есть точки расширения для этой интеграции. В его `README.md` перечислены восемь файлов, которые затрагивает плагин, а витрина лежит в [`apps/storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-robokassa/apps/storefront).
