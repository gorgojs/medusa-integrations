...
![Directory structure in the Medusa Storefront after updating the file for cookies](/static/robokassa/storefront/src-lib-data-cookies.webp)
...
![Directory structure in the Medusa Storefront after updating the file for payment component](/static/robokassa/storefront/src-modules-checkout-components-payment-index.webp)
...
![Directory structure in the Medusa Storefront after creating the file for API route](/static/robokassa/storefront/src-app-api-capture-payment-cartid-route.webp)
