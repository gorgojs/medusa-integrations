...
Every step above is written against the [Medusa Next.js Starter Template](https://github.com/medusajs/nextjs-starter-medusa) and links to the storefront it was taken from, pinned at [`examples/payment-robokassa/medusa-storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-robokassa/medusa-storefront).

The [example on `main`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-robokassa) builds on the [Medusa DTC Starter](https://github.com/gorgojs/medusa-dtc-starter), which ships the extension points this integration needs. Its `README.md` lists the eight files the plugin touches there, and its storefront lives in [`apps/storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-robokassa/apps/storefront).
