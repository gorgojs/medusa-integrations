...
- **Интерфейс в панели администратора:** Управление фидами прямо из Medusa Admin.
...
<CardList items={[
  {
    ...
    href: "https://github.com/gorgojs/medusa-integrations/tree/main/examples/feed-yandex"
  },
  {
    title: "История изменений",
    href: "/medusa-integrations/yandex-yml-feed/changelog"
  }
]}/>
