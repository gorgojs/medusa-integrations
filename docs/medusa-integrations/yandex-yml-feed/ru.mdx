...
- [Настройка окружения для разработки](https://github.com/gorgojs/medusa-integrations/tree/main/examples/feed-yandex)
- [История изменений](/medusa-integrations/yandex-yml-feed/changelog)
