...
- [Bootstrapping a development environment](https://github.com/gorgojs/medusa-integrations/tree/main/examples/erp-1c)
- [Changelog](/medusa-integrations/1c/changelog)
