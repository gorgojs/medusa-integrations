...
- **[Integration module](/medusa-modules/integration)**<AccentBadge bage="New" />: Configure this plugin directly in the Medusa Admin application — no editing configuration files or redeploying the store.
