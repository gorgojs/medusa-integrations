...
- **Integration Module**<AccentBadge bage="New" />: Configure this plugin directly in the Medusa Admin application — no editing configuration files or redeploying the store.
