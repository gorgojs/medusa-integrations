...
![Directory structure in the Medusa Storefront after updating the file for constants](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/payment/path-storefront-src-lib-constants.png)
...
![Directory structure in the Medusa Storefront after updating the file for cookies](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/payment/path-storefront-src-lib-data-cookies.png)
...
![Directory structure in the Medusa Storefront after updating the file for payment component](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/payment/path-storefront-src-modules-checkout-components-payment-index.png)
...
![Directory structure in the Medusa Storefront after updating the file for payment button component](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/payment/path-storefront-src-modules-checkout-components-payment-button-index.png)
...
![Directory structure in the Medusa Storefront after creating the file for API route](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/payment/path-storefront-src-app-api-capture-payment-cartid-route.png)
...
Every step above is written against the [Medusa Next.js Starter Template](https://github.com/medusajs/nextjs-starter-medusa) and links to the storefront it was taken from, pinned at [`examples/payment-tkassa/medusa-storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-tkassa/medusa-storefront).

The [example on `main`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-tkassa) builds on the [Medusa DTC Starter](https://github.com/gorgojs/medusa-dtc-starter), which ships the extension points this integration needs. Its `README.md` lists the eight files the plugin touches there, and its storefront lives in [`apps/storefront`](https://github.com/gorgojs/medusa-integrations/tree/main/examples/payment-tkassa/apps/storefront).
