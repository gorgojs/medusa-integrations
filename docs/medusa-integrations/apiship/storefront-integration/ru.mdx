...
![Структура проекта Medusa Storefront после обновления файла для компонента адреса доставки](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-address-index.png)
...
![Структура проекта Medusa Storefront после обновления файла для корзины](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-lib-data-cart.png)
...
![Структура проекта Medusa Storefront после обновления файла для фулфилмента](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-lib-data-fulfillment.png)
...
![Структура проекта Medusa Storefront после создания файла для типов ApiShip](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-types-index.png)
...
![Структура проекта Medusa Storefront после создания файла для утилит](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-utils-index.png)
...
![Структура проекта Medusa Storefront после создания файла карты пунктов самовывоза](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-map.png)
...
![Структура проекта Medusa Storefront после создания файла для выбранного тарифа и пункта самовывоза](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-chosen.png)
...
![Структура проекта Medusa Storefront после создания файла для модального окна пункта самовывоза ApiShip](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-pickup-point-modal.png)
...
![Структура проекта Medusa Storefront после создания файла для модального окна курьера ApiShip](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-courier-modal.png)
...
![Структура проекта Medusa Storefront после создания файла для единой точки входа для интеграции](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-index.png)
...
![Структура проекта Medusa Storefront после обновления файла для компонента доставки](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-index.png)
