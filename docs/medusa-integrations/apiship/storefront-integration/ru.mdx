...
![Структура проекта Medusa Storefront после обновления файла для компонента адреса доставки](/static/apiship/storefront/src-modules-checkout-components-shipping-address-index.webp)
...
![Структура проекта Medusa Storefront после обновления файла для корзины](/static/apiship/storefront/src-lib-data-cart.webp)
...
![Структура проекта Medusa Storefront после обновления файла для фулфилмента](/static/apiship/storefront/src-lib-data-fulfillment.webp)
...
![Структура проекта Medusa Storefront после создания файла для типов ApiShip](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-types-index.webp)
...
![Структура проекта Medusa Storefront после создания файла для утилит](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-utils-index.webp)
...
![Структура проекта Medusa Storefront после создания файла карты пунктов самовывоза](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-map.webp)
...
![Структура проекта Medusa Storefront после создания файла для выбранного тарифа и пункта самовывоза](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-chosen.webp)
...
![Структура проекта Medusa Storefront после создания файла для модального окна пункта самовывоза ApiShip](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-pickup-point-modal.webp)
...
![Структура проекта Medusa Storefront после создания файла для модального окна курьера ApiShip](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-courier-modal.webp)
...
![Структура проекта Medusa Storefront после создания файла для единой точки входа для интеграции](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-index.webp)
...
Откройте [`src/modules/checkout/components/shipping/index.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) и добавьте следующее:

![Структура проекта Medusa Storefront после обновления файла для компонента доставки](/static/apiship/storefront/src-modules-checkout-components-shipping-index.webp)
