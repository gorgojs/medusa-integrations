...
![Directory structure in the Medusa Storefront after updating the file for shipping address component](/static/apiship/storefront/src-modules-checkout-components-shipping-address-index.webp)
...
![Directory structure in the Medusa Storefront after updating the file for cart](/static/apiship/storefront/src-lib-data-cart.webp)
...
![Directory structure in the Medusa Storefront after updating the file for fulfillment](/static/apiship/storefront/src-lib-data-fulfillment.webp)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip types](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-types-index.webp)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip utilities](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-utils-index.webp)
...
![Directory structure in the Medusa Storefront after creating the file for pickup point map](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-map.webp)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip chosen](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-chosen.webp)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip pickup point modal window](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-pickup-point-modal.webp)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip courier modal window](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-apiship-courier-modal.webp)
...
![Directory structure in the Medusa Storefront after creating the file for single entry point for the integration](/static/apiship/storefront/src-modules-checkout-components-shipping-apiship-index.webp)
...
Open [`src/modules/checkout/components/shipping/index.tsx`](https://github.com/gorgojs/medusa-integrations/blob/7aa21a2d0331f60495ad85be74fcaa1aa86dd2a5/examples/fulfillment-apiship/medusa-storefront/src/modules/checkout/components/shipping-address/index.tsx#L212) and add the following:

![Directory structure in the Medusa Storefront after updating the file for shipping component](/static/apiship/storefront/src-modules-checkout-components-shipping-index.webp)
