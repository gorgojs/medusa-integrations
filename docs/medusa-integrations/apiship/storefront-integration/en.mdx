...
![Directory structure in the Medusa Storefront after updating the file for shipping address component](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-address-index.png)
...
![Directory structure in the Medusa Storefront after updating the file for cart](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-lib-data-cart.png)
...
![Directory structure in the Medusa Storefront after updating the file for fulfillment](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-lib-data-fulfillment.png)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip types](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-types-index.png)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip utilities](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-utils-index.png)
...
![Directory structure in the Medusa Storefront after creating the file for pickup point map](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-map.png)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip chosen](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-chosen.png)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip pickup point modal window](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-pickup-point-modal.png)
...
![Directory structure in the Medusa Storefront after creating the file for ApiShip courier modal window](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-apiship-courier-modal.png)
...
![Directory structure in the Medusa Storefront after creating the file for single entry point for the integration](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-apiship-index.png)
...
![Directory structure in the Medusa Storefront after updating the file for shipping component](https://static.gorgojs.com/docs/medusa-integrations/storefront-integration/apiship/path-storefront-src-modules-checkout-components-shipping-index.png)
