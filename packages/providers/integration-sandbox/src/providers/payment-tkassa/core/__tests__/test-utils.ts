...
/**
 * Build a T-Kassa payment provider with its integration-module seam stubbed: unit tests
 * exercise the payment logic (Init/Confirm/Cancel/GetState), not options resolution.
 */
