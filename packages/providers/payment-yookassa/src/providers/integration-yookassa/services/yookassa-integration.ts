...
const descriptor = defineIntegration({
  ...
  options: {
    ...
    useReceipt: {
      ...
      hint: "yookassa.hints.useReceipt",
    },
    useAtolOnlineFFD120: {
      type: "boolean",
      default: false,
      ...
      hint: "yookassa.hints.useAtolOnlineFFD120",
